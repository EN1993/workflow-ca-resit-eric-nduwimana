...
})({"fXcz1":[function(require,module,exports) {
"use strict";
...
var _question1Ts = require("./question-1/question-1.ts");
var _question2 = require("./question-2/question-2");
var _question3 = require("./question-3/question-3");
var _question4 = require("./question-4/question-4");
var _question5 = require("./question-5/question-5");
function logName(name) {
    console.log("This is name", name);
}
logName("Jon");

},{"./question-1/question-1.ts":"f6v74","./question-2/question-2":"dKwfL","./question-3/question-3":"lRm84","./question-4/question-4":"50sQI","./question-5/question-5":"gZ3S9"}],"f6v74":[function(require,module,exports) {
...
},{}],"dKwfL":[function(require,module,exports) {
...
},{}],"lRm84":[function(require,module,exports) {
 ...
 */ parcelHelpers.export(exports, "getDiscountPercentage", ()=>getDiscountPercentage);
/**
 ...
 */ parcelHelpers.export(exports, "formatDecimalSpaces", ()=>formatDecimalSpaces);
/**
 ...
 * // Expect 101.80
 * convertToKrone(10)
 */ parcelHelpers.export(exports, "convertKrone", ()=>convertKrone);
/**
...
function convertKrone(amount, toKrone = true, kroneValue = 10.18) {
    if (toKrone) return formatDecimalSpaces(amount * kroneValue);
...
},{}],"50sQI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class ShoppingCart {
    ...
    addToCart(item) {
        ...
        if (!itemExists) this.cart.push(item);
    }
    // Set the parameter to be of the Item type and set the return
    //    type to be of the correct type
    removeFromCart(item) {
...
parcelHelpers.export(exports, "bread", ()=>bread);
parcelHelpers.export(exports, "cheese", ()=>cheese);
parcelHelpers.export(exports, "tomato", ()=>tomato);
parcelHelpers.export(exports, "lettuce", ()=>lettuce);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"fD7H8"}],"gZ3S9":[function(require,module,exports) {

},{}]},["fXcz1","ahc7M"], "ahc7M", "parcelRequireec58")
